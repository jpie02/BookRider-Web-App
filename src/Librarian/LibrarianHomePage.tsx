...
const LibrarianHomePage: React.FC = () => {
    ...
    const handleReturnOptionChange = (option: 'inPerson' | 'driver') => {
        ...
        setRentalReturnId(null);  // Reset rental return ID when changing return type
        setRentalReturnDetails(null);  // Reset details as well
    };
    ...
    return (
        <div className="bg-[#314757] min-h-screen">
            <header className="flex justify-around p-1 pr-4 space-x-2.5 bg-[#3B576C] text-white sticky top-0 z-[1000] shadow-md">
                <div>
                    <img
